...
export const employeeUiStrings = {
  en: {
    ...
    rtrvrLabel: 'Live equipment catalog (RTRVR)',
    equipmentAssetsTitle: '3D equipment sources',
    stepOf: 'Step',
  ...
  es: {
    ...
    rtrvrLabel: 'Catálogo de equipo en vivo (RTRVR)',
    equipmentAssetsTitle: 'Fuentes 3D de equipo',
    stepOf: 'Paso',
  ...
  'zh-Hans': {
    ...
    rtrvrLabel: '实时设备目录（RTRVR）',
    equipmentAssetsTitle: '3D 设备来源',
    stepOf: '步骤',
    debriefTitle: '教练复盘',
